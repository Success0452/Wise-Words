...
public class Stories extends AppCompatActivity {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!(author.getText().toString().equals("") || quotes.getText().toString().equals(""))){
                    ...
                    Toast.makeText(Stories.this, "All field required", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getValues(){
        ...
        database = FirebaseDatabase.getInstance();
        myRef = database.getReference("Stories");
        ...
        Toast.makeText(Stories.this, "Data Inputed...",Toast.LENGTH_SHORT).show();
