...
public class Motivational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Motivational Quotes");
        //offline
        ...
        adapter = new FirebaseRecyclerAdapter<SetQuotes, FirebaseViewHolder>(options) {
            ...
            public FirebaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new FirebaseViewHolder(LayoutInflater.from(Motivational.this).inflate(R.layout.row,parent,false));
            }
        };
